...
class CreateAppartementTest extends TestCase
{
    ...
    public function test_can_create_annonce_appartement()
    {
    ...
    public function test_can_not_create_annonce_appartement_categories_is_wrong()
    {
    ...
    public function test_can_not_create_annonce_appartement_if_not_connected()
    {
        ...
        $response = $this->post('/api/appartements', $request);
